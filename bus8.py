...
def get_schedule_for_route(route_prefix):
    ...
    # Dynamically determine top terminal names based on GTFS trips
    terminal_names = stops[stops['stop_id'].isin(terminal_stop_ids)]['stop_name'].tolist()
