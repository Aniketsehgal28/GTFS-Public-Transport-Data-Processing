...
# --- Run for all stops and all routes ---
all_stop_directional_data = get_schedule_all_stops()
for stop, directions in all_stop_directional_data.items():
